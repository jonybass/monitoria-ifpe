...
ALTER TABLE fotos ADD COLUMN arquivo VARCHAR(255) NOT NULL;


ALTER TABLE fotos
ADD COLUMN data_upload DATETIME DEFAULT CURRENT_TIMESTAMP AFTER arquivo;

ALTER TABLE fotos DROP COLUMN arquivo;
ALTER TABLE fotos DROP COLUMN data_upload;
